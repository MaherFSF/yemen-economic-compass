...
export default function YemenKuwaitBankPage() {
  return (
    <div className="w-full space-y-8">
      ...
      <div className="bg-gradient-to-r from-primary/10 to-accent/10 p-8 rounded-lg">
        ...
        <h1 className="text-4xl font-bold mb-2">Yemen Kuwait Bank</h1>
        <p className="text-lg text-muted-foreground">بنك اليمن والكويت</p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p>Comprehensive profile and analysis of Yemen Kuwait Bank including financial performance, challenges, and strategic recommendations.</p>
