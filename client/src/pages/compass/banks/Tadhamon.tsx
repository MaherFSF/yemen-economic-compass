...
export default function TadhamonIslamicBankPage() {
  return (
    <div className="w-full space-y-8">
      ...
      <div className="bg-gradient-to-r from-primary/10 to-accent/10 p-8 rounded-lg">
        ...
        <h1 className="text-4xl font-bold mb-2">Tadhamon Islamic Bank</h1>
        <p className="text-lg text-muted-foreground">بنك التضامن الإسلامي</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold">Islamic</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p>Comprehensive profile and analysis of Tadhamon Islamic Bank including financial performance, challenges, and strategic recommendations.</p>
