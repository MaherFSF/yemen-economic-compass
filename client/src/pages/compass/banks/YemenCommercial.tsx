...
export default function YemenCommercialBankPage() {
  return (
    <div className="w-full space-y-8">
      ...
      <div className="bg-gradient-to-r from-primary/10 to-accent/10 p-8 rounded-lg">
        ...
        <h1 className="text-4xl font-bold mb-2">Yemen Commercial Bank</h1>
        <p className="text-lg text-muted-foreground">البنك التجاري اليمني</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold">1971</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <p className="text-2xl font-bold">Sana'a</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <p className="text-2xl font-bold text-yellow-600">Restructuring</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p>Comprehensive profile and analysis of Yemen Commercial Bank including financial performance, challenges, and strategic recommendations.</p>
