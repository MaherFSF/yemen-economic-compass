...
export default function NationalBankofYemenPage() {
  return (
    <div className="w-full space-y-8">
      ...
      <div className="bg-gradient-to-r from-primary/10 to-accent/10 p-8 rounded-lg">
        ...
        <h1 className="text-4xl font-bold mb-2">National Bank of Yemen</h1>
        <p className="text-lg text-muted-foreground">البنك الأهلي اليمني</p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p>Comprehensive profile and analysis of National Bank of Yemen including financial performance, challenges, and strategic recommendations.</p>
